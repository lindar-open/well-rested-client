package org.spauny.joy.wellrested.terminal;

import java.util.Scanner;
import org.apache.commons.lang3.StringUtils;
import org.spauny.joy.wellrested.request.HttpsRequestProcessor;
            ...
            if (args[0].equals("execute")) {
                if (args.length > 1) {
                    ...
                    if (url.contains("https")) {
                        ...
                        response = new HttpsRequestProcessor(url).processGetRequest();
                    }
